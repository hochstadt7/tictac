Web application in a server / client structure, for the tic-tac-toc game. The server plays against several clients. It maintains a waiting list of non-gaming customers, sorted by their login order.
